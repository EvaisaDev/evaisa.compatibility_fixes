...
local cc_update_map = {
	hydroxide = "cc_hydroxide",
	acidWater = "cc_acidic_water",
	devouringMoss = "cc_devouring_moss",
	hydroxide_gas = "cc_hydroxide_gas",
	potionBlindness = "cc_veilium",
	sparkLiquid = "cc_sparkling_liquid",
	sliceLiquid = "cc_slicing_liquid",
	glitteringLiquid = "cc_glittering_liquid",
	blastPowder = "cc_blasting_powder",
	methane = "cc_methane",
	methaneRain = "cc_methane_rain",
	AA_MAT_BLOOM = "aa_bloom_solid",
	AA_MAT_BLOOM_ROOF = "aa_bloom_roof",
	AA_MAT_BLOOM_ROOF_DEAD = "aa_bloom_roof_dead",
	AA_MAT_BLOOM_ROOF_PLANT = "aa_bloom_roof_plant",
	AA_MAT_BLOOM_LIQUID = "aa_bloomium", --for some reason bloom liquid and bloom magic liquid appear to have been merged
	AA_MAT_BLOOM_GAS = "aa_bloomium_gas",
	AA_MAT_BLOOM_MAGIC = "aa_bloomium",
	AA_MAT_HITSELF = "aa_hitself",
	AA_MAT_DARKMATTER = "aa_darkmatter",
	AA_MAT_STATIC_CHARGE = "aa_static_charge",
	AA_MAT_REPULTIUM = "aa_repultium",
	AA_MAT_HUNGRY_SLIME = "aa_hungry_slime",
	AA_MAT_CREEPING_SLIME = "aa_creeping_slime",
	AA_MAT_HUNGRY_SLIME_GROWING = "aa_hungry_slime_growing",
	AA_MAT_ASH = "aa_ash",
	AA_MAT_SOOT = "aa_soot",
	AA_MAT_POTION_GAS = "aa_potion_gas",
	AA_MAT_SOLID_SLIME = "aa_solidified_slime",
	AA_MAT_NEUTRAL_POTION = "aa_base_potion",
	AA_MAT_ARBORIUM = "aa_arborium",
	AA_MAT_CATALYST = "aa_catalyst",
	AA_MAT_OIL_SPLITTING = "aa_oil_splitting",
	AA_MAT_OIL_LIGHT = "aa_light_oil",
	AA_MAT_OIL_HEAVY = "aa_heavy_oil",
	AA_MAT_MAGICPLASTIC = "aa_magic_plastic",
	AA_LOVE = "aa_love",
	AA_PATH = "aa_meagre_offering",
	rice = "aa_rice",
	AA_ICEFIRE = "aa_icy_inferno",
	AA_LIQUID_SPELL = "aa_pandorium",
	AA_UNSTABLE_LIQUID_SPELL = "aa_unstable_pandorium",
	AA_LIQUID_ROCK = "aa_pop_rocks",
	AA_GRAVLIQUID = "aa_condensed_gravity",
	AA_CLONE = "aa_cloning_solution",
	AA_MAT_COMPOST = "aa_compost",
	AA_MATTER_EATER = "aa_strange_matter",
	twitchyJuice = "cc_ectospasm",
	cc_twitchy_liquid = "cc_ectospasm", --this mat was renamed again not too long ago
	fireStarter = "cc_kindling",
	magic_liquid_movement_slower = "cc_deceleratium",
	magic_liquid_slower_levitation = "cc_heftium",
	magic_liquid_slower_levitation_and_movement = "cc_stillium",
	metamorphine = "cc_metamorphine",
	unstableMetamorphine = "cc_unstable_metamorphine",
	explodePlayer = "cc_explode_player",
	alchemyPowder = "cc_alchemy_powder",
	liquid_projectile_trail = "cc_metastasizium",
	antimagic = "cc_nullium",
	wand_tinker = "cc_liberum_magicas",
	lightningPowder = "cc_thunder_powder",
	increaseMaxHP = "cc_health_tonic",
	grease = "cc_grease",
	solidCrystal = "cc_dormant_crystal",
	solidCrystal_molten = "cc_dormant_crystal_molten",
	uranium = "cc_uranium",
	radiationWaste = "cc_radioactive_waste",
	squirrellymorphine = "cc_morphine",
	antimatter_gas = "cc_antimatter_gas",
	antimatter_liquid = "cc_antimatter_liquid",
	frozen_meat = "cc_frozen_meat",
	cobalt = "cc_cobalt",
	cobalt_molten = "cc_cobalt_molten",
	iron = "cc_iron",
	iron_molten = "cc_iron_molten",
	preskite = "cc_preskite",
	preskite_molten = "cc_preskite_molten",
	iron_ingredient = "cc_ferrine",
	cobalt_ingredient = "cc_cobaline",
	crystal_box2d = "cc_crystal_box2d",
	ferrineSkin = "cc_persistine",

	AA_GROWTH = "", --does not currently exist in Chemical Curiosities
	AA_GLUE = "", --does not currently exist in Chemical Curiosities
	AA_MAT_SHRINKIUM = "", --does not currently exist in Chemical Curiosities
}
